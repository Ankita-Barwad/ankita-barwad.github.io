        ...
        <div class="w3-row-padding">
          <div class="w3-container w3-third " id="hobby-image">
            <img src="./images/hobby-background.jpg" alt="hobby" style="width: 50%;"
              onclick="document.getElementById('modal-hobby').style.display='block'" class="w3-hover-opacity">
            <p class="w3-wide" style="text-align: center;">Hobby</p>
          </div>
          <div class="w3-container w3-third " id="hobby-image">
            <img src="./images/skills-background.jpg" alt="skills" style="width: 50%; height: 150%;"
              onclick="document.getElementById('modal-skills').style.display='block'" class="w3-hover-opacity">
          ...
          <div class="w3-container w3-third education-image" id="hobby-image">
            <img src="./images/education-background.png" alt="Education" style="width: 55%; height: 135px;"
              onclick="document.getElementById('modal-education').style.display='block'" class="w3-hover-opacity">
        ...
        <div id="modal-skills" class="w3-modal" onclick="this.style.display='none'">
          ...
          <div class=" w3-modal-content w3-animate-zoom hobby-modal">
            ...
            <div class="padding-16  small-headings my-exposures-padding my-skills-background"
              ...
              <div class="row1">
                <div class="col-sm-4">
                  <img src="./images/html-logo.jpg" class="img-circle" alt="HTML" width="70" height="70">
                </div>
                <div class="col-sm-4">
                  <img src="./images/visual-studio-code-logo.jpg" class="img-circle" alt="visual studio code" width="70"
                    height="70">
                </div>
                <div class="col-sm-4">
                  <img src="./images/css-logo.jpg" class="img-circle" alt="css" width="70" height="70">
                </div>
              </div>

              <div class="row2">
                <div class="col-sm-4">
                  <img src="./images/bootstrap-logo.jpg" class="img-circle" alt="bootstrap" width="70" height="70">
                </div>
                <div class="col-sm-4">
                  <img src="./images/java-logo.jpg" class="img-circle" alt="java" width="70" height="70">
                </div>
                <div class="col-sm-4">
                  <img src="./images/js-logo.jpg" class="img-circle" alt="jQuery" width="70" height="70">
                </div>
              </div>
              <div class="row3">
                <div class="col-sm-4">
                  <img src="./images/git-logo.jpg" class="img-circle" alt="git" width="70" height="70">
                </div>
                <div class="col-sm-4">
                  <img src="./images/eclipse-logo.jpg" class="img-circle" alt="eclipse" width="70" height="70">
                </div>
                <div class=col-sm-4>
                  <img src="./images/spring-logo.png" class="img-circle" alt="eclipse" width="70" height="70">
                </div>
                <div class=col-sm-4>
                  <img src="./images/angular-logo.jpg" class="img-circle" alt="angular" width="70" height="70">
                </div>
                <div class=col-sm-4>
                  <img src="./images/agile-logo.png" class="img-circle" alt="agile" width="110" height="70">
                </div>
                <div class=col-sm-4>
                  <img src="./images/python-logo.jpg" class="img-circle" alt="python" width="70" height="70">
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="carousel-inner">
                ...
                <div class="item">
                  ...
                  <p class="project-details left">
                    ...
                    better
                    engagement, which reduces bounce rate and improves mobile ranking.<br> <i style="font-size: 24px"
                      class="fa">&#xf101;</i><b>Technology Used:</b> HTML,
                    CSS,
                    Google-AMP<br>
